...
public class Vehicule {
    ...
    //private int id_marque; // Identifiant du modèle du véhicule (clé étrangère vers la table "MODELE")
     ...
     * @param id_modele Identifiant du modèle associé au véhicule
     //* @param id_marque Identifiant du modèle associé au véhicule
     */
    public Vehicule(int id_vehicule, String matricule, int annee_sortie, double poids, 
       ...
       // this.id_marque = id_marque; // Initialisation de l'identifiant du modèle
    }
   ...
   // public int getIdMarque() {
        //return id_marque; // Retourne l'identifiant du modèle associé au véhicule
    //}
